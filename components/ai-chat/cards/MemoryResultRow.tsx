    ...
    <YStack padding={14} gap={8}>
      ...
      {isReminder && dueAtLabel ? (
        <XStack alignItems="center" gap={5}>
          <Feather name="clock" size={11} color={theme.textWarning.val} />
          <Text fontSize={11} fontFamily={FontFamily.semiBold} color={theme.textWarning.val}>
            {dueAtLabel}
          </Text>
        </XStack>
      ) : null}
  ...
  const row = (
    ...
    >
      ...
      <YStack flex={1} gap={5} minWidth={0}>
        ...
        {isReminder && dueAtLabel ? (
          <XStack alignItems="center" gap={5}>
            <Feather name="clock" size={10} color={theme.textWarning.val} />
            <Text fontSize={10} fontFamily={FontFamily.semiBold} color={theme.textWarning.val}>
              {dueAtLabel}
            </Text>
          </XStack>
        ) : null}
